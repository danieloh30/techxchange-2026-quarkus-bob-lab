...
!!! tip "Agentic Dev UI"
    ...
    Also check the **topology** at **http://localhost:8080/q/dev-ui/quarkus-langchain4j-agentic/topology** — compare it to Exercise 4. The tree now includes the HITL agents branching off the supervisor.
