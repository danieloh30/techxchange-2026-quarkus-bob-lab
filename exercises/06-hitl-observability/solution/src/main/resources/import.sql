...
INSERT INTO incident_info (id, system_name, service, priority, description, status) VALUES
    -- P1/P2 on revenue-critical systems - Will trigger HITL approval
    ...
    -- P3/P4 or non-critical systems - Automated escalation (no HITL)
    ...
    -- Regular incidents for testing triage/investigation only
