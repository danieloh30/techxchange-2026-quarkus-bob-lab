...
public interface ResolutionAgent {
    ...
    @SystemMessage("""
        ...
        Rules:
        - incidentAction: ESCALATE_INCIDENT->ESCALATE, RESOLVE_INCIDENT+investigation->INVESTIGATE, RESOLVE_INCIDENT+triage->TRIAGE, RESOLVE_INCIDENT+none->RESOLVE
    ...
    @UserMessage("""
            ...
            """)
    @Agent(description = "Final incident resolution analyzer. Determines the incident's resolution, action, and approval status based on all analysis.",
