...
function filterIncidents() {
    ...
    return incidentsData.filter(incident => {
        ...
        return (
            ...
            (incident.priority && incident.priority.toLowerCase().includes(ft)) ||
...
function openDetailPanel(incidentId) {
    ...
    if (canProcess) {
        formHtml = `
            ...
            <textarea id="detail-feedback" class="detail-textarea" placeholder="Enter report details..."></textarea>
    ...
    body.innerHTML = `
        ...
        <div class="detail-field">
            ...
            <div class="detail-value"><span class="priority-badge priority-${incident.priority ? incident.priority.toLowerCase() : ''}">${incident.priority || 'N/A'}</span></div>
        </div>
        <div class="detail-field">
...
function processFromPanel(incidentId, status) {
    const feedback = document.getElementById('detail-feedback').value;
